...
namespace BL
{
    public class BLContext : DbContext
    {
        ...
        //public DbSet<ImageLocation> ImagesLocation { get; set; }
    ...
    class MyContextInitializer : DropCreateDatabaseAlways<BLContext>
    {
        protected override void Seed(BLContext db)
        {
            ...
            TypeExtinguisher te1 = new TypeExtinguisher { Name = "ОП-4" };
            db.TypeExtinguishers.Add(te1);
            ...
            Extinguisher e1 = new Extinguisher { FireCabinet = f1, Number = 1, TypeExtinguisher = te1 };
            Extinguisher e2 = new Extinguisher { FireCabinet = f2, Number = 1, TypeExtinguisher = te1 };
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    for (int i = 0; i < properties.Count; i++)
                    {
                        if (properties[i].PropertyType == typeof(string))
                            //properties[i].SetValue(curr, Int32.Parse(values[i]));
